...
#### Assignment question: Run the k-test for for either the A or B edgelist files (which correspond to two different colonies of ground squirrels). Export the network plot you made above as well as density graph generated by the k-test. Record the p-value for the mean. Please put these into a word doc (or R Markdown), and, in your own words, interpret the k-test output. What is the null hypothesis being tested? What does the blue shaded area and red line represent in the plot? And how do you interpret the p-value?
