library(igraph)
#as a funtion for a igraph object with attributes "name" and "state".  State should be a numeric with 0 indicating uninfected nodes.  Infected nodes should have a state of 1.
...
#if node type is speciefied, than randomization occurs iwthin node types
